...
import rnxmpp.exelement.ST;
import rnxmpp.exelement.STProvider;
import rnxmpp.exelement.SentProvider;
...
//                    }
    ...
    public void leaveRoom(String roomJid) {
        ...
        if (muc.isJoined()) {
            logger.log(Level.INFO, "已经进入该房间");
        } else {
            logger.log(Level.INFO, "没有进入该房间");
        }
