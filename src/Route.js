...
const RootStack = createStackNavigator({
	...
	onTransitionEnd: (transitionProps,prevTransitionProps) => {
		...
		//
		// console.log(transitionProps.navigation.state.routes);
		// console.log(prevTransitionProps.navigation.state.routes);
		// let old_routes = prevTransitionProps.scenes;
		// old_routes.map((route,index) => {
		// 	if(route.route.routeName != 'Index' && route.route.routeName === transitionProps.scene.route.routeName){
		// 		transitionProps.navigation.dispatch(StackActions.reset({
		// 			index: route.index,
		// 			actions: [
