...
export default class InvitePublish extends Component {
	...
	_selectJobInviteDay = (date) => {
		...
		this.setState({
			...
			console.log(this.state.jobBody)
		});
	}
				...
				<ScrollView
					...
					<View style={styles.inviteContainer}>
						...
						<View style={styles.inviteGroup}>
							...
							<TouchableOpacity style={styles.inviteTouch} onPress={()=>{HandlerOnceTap(
                                () => {
						...
						<View style={styles.inviteGroup}>
							...
							<TouchableOpacity style={styles.inviteTouch} onPress={()=>{HandlerOnceTap(this._showDateTimePicker)}}>
					...
					<View style={styles.inviteContainer}>
						{Platform.OS == 'ios' ? null : (<View style={[styles.inviteGroup, {borderTopColor: 'transparent'}]}>
							...
							<TouchableOpacity style={styles.inviteTouch} onPress={()=>{HandlerOnceTap(this._updateFile)}}>
					...
					<View style={styles.separatorLine}/>
					<View style={styles.inviteContainer}>
						<TouchableOpacity style={styles.inviteSubmit} onPress={()=>{HandlerOnceTap(this._postInvite)}}>
