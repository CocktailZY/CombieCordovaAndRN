...
const HEAD_COLOR = ['#dfe755', '#20e665', '#e5a844', '#278eee'];
...
class Vote extends Component {
	...
	voteListCallBack = (res) => {
		...
		if (res.code.toString() == '200') {
			this.setState({
				dataSource: res.data.currentPage == 1 ? res.data.recordList : this.state.dataSource.concat(res.data.recordList),
