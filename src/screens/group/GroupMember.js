...
export default class Group extends Component {
	...
	_fetchMember = () => {
		let url = Path.getGroupMember + '?uuId=' + this.state.uuid + '&ticket=' + this.state.ticket + '&roomJid=' + this.state.roomJid + '&currentJidNode=' + this.state.basic.jidNode + '&userId=' + this.state.basic.userId;

		FetchUtil.netUtil(url, {}, 'GET', this.props.navigation, '', (responseJson) => {
			//console.log(responseJson);
			this.listLength = responseJson.data.length;
			let groupUser = this.state.groupOwner,
				nowUser = this.state.basic.jidNode;
				let flag = false;
