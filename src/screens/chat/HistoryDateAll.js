				...
				if (body.type != undefined && body.type == 2) {
					if (body.content.file[0].listFileInfo[0].showPic == 'img') {
						...
						box.push({
							...
							// url: Path.baseImageUrl + '?type=image&uuId=' + this.state.uuid + '&ticket=' + this.state.ticket + '&fileId=' + body.content.file[0].listFileInfo[0].id + '&userId=' + this.state.basic.userId
						});
					}
				}
			}
											...
											<View key={index}
												...
												</View>
												{
													type == 'me' ?
														<Image
															source={{
																uri: Path.headImgNew + '?uuId=' + this.state.uuid + '&ticket=' + this.state.ticket + '&userId=' + this.state.basic.userId + '&imageName=' + '' + '&imageId=' + '' + '&sourceType=singleImage&jidNode=' + meId
